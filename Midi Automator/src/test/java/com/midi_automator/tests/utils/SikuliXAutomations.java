...
public class SikuliXAutomations extends SikuliAutomation {
	...
	public static void cancelNSISInstaller() throws FindFailed {
		Region match = SikuliXAutomations.findMultipleStateRegion(DEFAULT_TIMEOUT,
	...
	public static void setAndSavePreferencesComboBox(String scLabel,
		...
		SikuliAutomation.setSearchRegion(SikuliXAutomations
	...
	public static void deleteEntry(String state1, String state2, String state3)
			throws FindFailed {
		SikuliXAutomations.openPopupMenu(state1, state2, state3);
		Region match = SikuliAutomation.getSearchRegion().wait(
	...
	public static void checkIfNoResult(String screenshot, String error) {
		try {
			SikuliXAutomations.checkResult(screenshot, DEFAULT_TIMEOUT);
			fail(error);
		} catch (FindFailed e) {
